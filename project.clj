(defproject net.clojars.stylitics-graal/reitit-parent "0.7.1"
  ...
  :managed-dependencies [[metosin/reitit "0.7.1"]
                         [metosin/reitit-core "0.7.1"]
                         [metosin/reitit-dev "0.7.1"]
                         [metosin/reitit-spec "0.7.1"]
                         [metosin/reitit-malli "0.7.1"]
                         [metosin/reitit-schema "0.7.1"]
                         [metosin/reitit-ring "0.7.1"]
                         [metosin/reitit-middleware "0.7.1"]
                         [metosin/reitit-http "0.7.1"]
                         [metosin/reitit-interceptors "0.7.1"]
                         [metosin/reitit-swagger "0.7.1"]
                         [fi.metosin/reitit-openapi "0.7.1"]
                         [metosin/reitit-swagger-ui "0.7.1"]
                         [metosin/reitit-frontend "0.7.1"]
                         [metosin/reitit-sieppari "0.7.1"]
